...
export const FERME_STR = {
  fr: {
    ...
    townActLines: {
      sit: ["On est bien, ici.", "Cinq minutes. Juste cinq minutes.", "Les pieds, à mon âge...", "Il passe du monde, aujourd'hui."],
      fountain: ["L'eau est fraîche.", "On dit qu'elle exauce les vœux. On dit tant de choses.", "Elle coule depuis plus longtemps que nous tous."],
      kiosk: ["Ils devraient jouer plus souvent.", "Ça me rappelle quelque chose.", "Un jour, je monterai là-dessus."],
      stall: ["Trop cher. Comme toujours.", "Vous n'auriez pas plus mûr ?", "Je prends les deux. Non, les trois."],
      well: ["Elle est bonne, celle-là.", "Il faudrait la curer, un de ces jours."],
      grave: ["Salut à toi.", "On pense à vous, vous savez."],
      pier: ["Ça mord, par là ?", "Le lac est plat comme une assiette.", "J'aime venir ici quand il n'y a personne."],
      view: ["De là-haut, on voit la ferme.", "Toute la vallée. Rien que pour nous.", "Ça valait la montée."],
      window: ["Je n'oserais jamais porter ça.", "Un jour. Un jour.", "Vous avez vu le PRIX ?"],
  ...
  en: {
    ...
    townActLines: {
      sit: ["This is the good life.", "Five minutes. Just five.", "My feet, at my age...", "Busy today, isn't it."],
      fountain: ["The water is cold.", "They say it grants wishes. They say a lot of things.", "It has been running longer than all of us."],
      kiosk: ["They should play more often.", "This reminds me of something.", "One day I'll get up there."],
      stall: ["Too dear. As always.", "Nothing riper than that?", "I'll take both. No, all three."],
      well: ["That one's good water.", "Wants dredging, one of these days."],
      grave: ["Hello, you.", "We think of you, you know."],
      pier: ["Anything biting out there?", "The lake is flat as a plate.", "I like it here when nobody's about."],
      view: ["You can see the farm from up here.", "The whole valley. All ours.", "Worth the climb."],
      window: ["I'd never dare wear that.", "One day. One day.", "Have you SEEN the price?"],
