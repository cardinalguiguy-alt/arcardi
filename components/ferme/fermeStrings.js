...
export const FERME_STR = {
  fr: {
    ...
    houseRowTitle: (lvl) => `🏠 Maison (niveau ${lvl})`,
    houseRowSub: "Améliore la maison de la ferme (nouveau visuel à chaque niveau). Bois/pierre prélevés sur TON inventaire, or sur la caisse commune.",
    ...
    houseWorksStarted: (name, lvl) => `${name} a lancé les travaux de la maison (vers le niveau ${lvl}) !`,
    houseUpgraded: (lvl) => `🎉 La maison est passée au niveau ${lvl} !`,
  ...
  en: {
    ...
    houseRowTitle: (lvl) => `🏠 House — level ${lvl}`,
    houseRowSub: "Upgrades the farm house (new look at each level). Wood/stone taken from YOUR inventory, gold from the shared pot.",
    ...
    houseWorksStarted: (name, lvl) => `${name} started the house works (towards level ${lvl})!`,
    houseUpgraded: (lvl) => `🎉 The house reached level ${lvl}!`,
