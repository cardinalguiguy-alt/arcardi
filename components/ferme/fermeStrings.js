...
export const FERME_STR = {
  fr: {
    ...
    fertilizerOrderCountLabel: "Nombre de cases",
    fertilizerOrderCost: (n) => `Coût : ${n} engrais`,
    fertilizerOrderHint: "Greg accélère la pousse des cultures déjà plantées autour de l'endroit où tu te trouveras quand tu lanceras l'ordre.",
  ...
  en: {
    ...
    fertilizerOrderCountLabel: "Number of tiles",
    fertilizerOrderCost: (n) => `Cost: ${n} fertilizer`,
    fertilizerOrderHint: "Greg will speed up the growth of already-planted crops around wherever you're standing when you launch the order.",
