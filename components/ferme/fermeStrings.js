...
export const FERME_STR = {
  fr: {
    ...
    sucrerieRowSub: (n) => `Transforme la canne à sucre déposée en sacs de sucre, tant que Jérôme Martial est installé (chantier d'1 heure réelle) · en stock : ${n}`,
    // Bac de vente
  ...
  en: {
    ...
    sucrerieRowSub: (n) => `Continuously turns deposited sugar cane into sugar sacks, as long as Jérôme Martial lives there (1 real hour to build) · in stock: ${n}`,
    binTitle: "💰 Sell bin",
