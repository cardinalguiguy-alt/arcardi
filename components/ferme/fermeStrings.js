...
export const FERME_STR = {
  ...
  en: {
    ...
    chloeRosalieScenes: [
      [{ who: "chloe", text: "Rosalie! We do NOT talk to people like that!" }, { who: "rosalie", text: "I was just telling the truth." }, { who: "chloe", text: "We don't care, we're POLITE!" }, { who: "rosalie", text: "...Fine, fine, I get it." }, { who: "chloe", text: "Sorry, she had a rough night..." }],
      [{ who: "chloe", text: "I heard ALL of that from the bakery, you know!" }, { who: "rosalie", text: "I'm allowed an opinion, aren't I?" }, { who: "chloe", text: "Not like that, Rosalie, NEVER like that!" }, { who: "rosalie", text: "Okay, okay, got it..." }, { who: "chloe", text: "A little manners, just a little!" }, { who: "rosalie", text: "The sourdough's grumpy, not me." }, { who: "chloe", text: "Sorry about her. Good heart, deep down." }, { who: "rosalie", text: "Hmph." }],
      ...
      [{ who: "chloe", text: "We respect people here, Rosalie, end of st—" }, { who: "chloe", text: "OH MY BREAD!", ms: 1800 }, { who: "rosalie", text: "...Saved by the bell." }, { who: "chloe", text: "Sorry anyway!" }],
      [{ who: "chloe", text: "That was really, really not nice!" }, { who: "chloe", text: "Rosalie?" }, { who: "rosalie", text: "I didn't say anything." }, { who: "chloe", text: "That's the problem. Will you ever apologize?" }, { who: "rosalie", text: "We'll see." }, { who: "chloe", text: "...and sorry for my tone, but someone had to." }],
      ...
      [{ who: "chloe", text: "We do not grumble at customers. WE. DO. NOT. GRUMBLE.", ms: 4200 }, { who: "rosalie", text: "...Done with the list?" }, { who: "chloe", text: "There's a fourth point if you insist." }, { who: "rosalie", text: "No, no, I got the general idea." }, { who: "chloe", text: "Sorry about her. Tough crust, soft crumb." }, { who: "rosalie", text: "Thanks... I think." }],
      [{ who: "chloe", text: "Rosalie, seriously! We don't talk to people like that!" }, { who: "rosalie", text: "It was nothing. A remark. A fact." }, { who: "chloe", text: "It wasn't nothing." }, { who: "chloe", text: "...Sorry anyway, maybe that was a bit much." }, { who: "rosalie", text: "...Whatever. It's fine." }],
    ...
    tristanJeromeScenes: [
      ...
      [{ who: "tristan", text: "Well, well. If it isn't little sugar boy, out of his shop for once." }, { who: "jerome", text: "Little sugar boy makes twice your revenue, Tristan." }, { who: "tristan", text: "Your revenue, your revenue... that's the only word you know." }, { who: "jerome", text: "Because all you've got is logs, exactly." }, { who: "tristan", text: "Say that again, you ridiculous pathetic little guy." }, { who: "jerome", text: "Little guy? Look at your size next to that ego of yours." }, { who: "tristan", text: "#%!&, you're really starting to get me going." }, { who: "jerome", text: "Good, makes a change from sawdust." }, { who: "tristan", text: "You asked for this." }],
      [{ who: "jerome", text: "So, log-boy, sleep well last night?" }, { who: "tristan", text: "Always so charming, Jérôme." }, { who: "jerome", text: "Always so charming. And you, always so... furniture." }, { who: "tristan", text: "Furniture? Furniture that could fold you in half, you mean." }, { who: "jerome", text: "Try it, big arms, we'll see who folds who." }, { who: "tristan", text: "Pathetic little guy. You talk big when there's a crowd around." }, { who: "jerome", text: "And you think hard when there's nobody around to hear it, apparently." }, { who: "tristan", text: "#%!&. That's enough now." }, { who: "jerome", text: "Finally, a short sentence, well done." }],
      [{ who: "tristan", text: "Jérôme, I heard what you told Ingrid yesterday." }, { who: "jerome", text: "Oh yeah? Well, it's not like it was false." }, { who: "tristan", text: "You said I could only count up to three logs." }, { who: "jerome", text: "And have you proven otherwise since?" }, { who: "tristan", text: "Keep it up, little sugar boy, keep it up." }, { who: "jerome", text: "Little sugar, little sugar... it's the only thing you've got. The sugar mill is mine, not yours." }, { who: "tristan", text: "Ridiculous. You're ridiculous, that's what you are." }, { who: "jerome", text: "Ridiculous but loved by everyone. You're just a lumberjack. And alone." }, { who: "tristan", text: "#%!&, there it is, you got me." }, { who: "jerome", text: "Finally, a win, for today." }],
      [{ who: "tristan", text: "You got a problem, Jérôme?" }, { who: "jerome", text: "You. Entirely. That's been my problem from the start." }, { who: "tristan", text: "Say that again, you pathetic little guy." }, { who: "jerome", text: "Pathetic? Look at you, you're already shaking with rage." }, { who: "tristan", text: "#%!&." }, { who: "jerome", text: "Still so chatty, I see." }],
    ],
