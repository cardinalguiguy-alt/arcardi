...
export const FERME_STR = {
  fr: {
    ...
    devBannerTitle: "Le passage est forcé par le menu développeur. L'hôte peut rétablir la rotation avec Cmd/Ctrl+Shift+X.",
  ...
  en: {
    ...
    devBannerTitle: "The passage is forced from the developer menu. The host can restore the rotation with Cmd/Ctrl+Shift+X.",
