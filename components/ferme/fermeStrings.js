...
export const FERME_STR = {
  fr: {
    ...
    chatTitle: "Chat de la vallée",
    chatOpen: "Ouvrir le chat",
    chatSendBtn: "Envoyer",
    chatClose: "Fermer le chat",
    mobileMenu: "Commandes mobiles",
    mobileQuest: "Quêtes",
    mobileBag: "Sac",
    rotateTitle: "Tournez l’appareil",
    rotateBody: "Valley Farm se joue en paysage.",
    hireLabel: "Engager",
  ...
  en: {
    ...
    rotateBody: "Valley Farm is played in landscape.",
    hireLabel: "Hire",
