...
export const FERME_STR = {
  fr: {
    ...
    buildingName: (bid) => ({ beehive: "Ruche", fromagerie: "Fromagerie", bakery: "Boulangerie" }[bid] || bid),
  ...
  en: {
    ...
    buildingName: (bid) => ({ beehive: "Beehive", fromagerie: "Cheese dairy", bakery: "Bakery" }[bid] || bid),
