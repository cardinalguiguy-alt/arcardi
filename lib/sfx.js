...
// dés gardés ne comptent pas) : un mélange "few" plus discret sous 4 dés, un
// mélange "many" plus fourni à partir de 4. Retourne le nœud audio joué pour
// pouvoir le couper à la révélation (ou lors d'un double-clic qui écourte).
