...
export const QUESTIONS = [
  ...
  { id: "s066", cat: "strange", fr: ["ne plus jamais voir un seul animal", "que tous les animaux veuillent se battre avec toi, quelle que soit leur taille"], en: ["never seeing a single animal again", "having every animal want to fight you, whatever its size"] },
  ...
  { id: "d063", cat: "dilemma", fr: ["mourir avant ton ou ta partenaire", "mourir après ton ou ta partenaire"], en: ["dying before your partner", "dying after your partner"] },
  ...
  // prochain id libre : s068 / c065 / p064 / d076
];
