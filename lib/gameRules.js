    ...
    fr: {
      ...
      sections: [
        { h: "Déroulé d'une manche", items: [
          "1. Une question apparaît. Chacun choisit A ou B EN SECRET, puis verrouille son choix.",
          "2. Chacun tente ensuite de DEVINER le choix de l'adversaire, et verrouille sa devinette.",
          "3. Les deux choix et les deux devinettes sont révélés en même temps.",
        ] },
        { h: "Score", items: [
          "+1 point pour chacun si vous avez choisi la MÊME réponse (compatibilité).",
          "+1 point pour vous si vous avez correctement deviné le choix de l'adversaire.",
          "Soit 0, 1 ou 2 points par manche et par joueur.",
        ] },
        { h: "Fin de partie", items: [
          "On enchaîne les manches jusqu'à ce qu'un joueur atteigne le score cible AVEC au moins un point d'avance (pas de victoire à égalité).",
          "L'hôte règle le score à atteindre, le temps par phase et les types de questions avant de lancer.",
        ] },
      ],
    },
    en: {
      ...
      sections: [
        { h: "How a round works", items: [
          "1. A question appears. Each of you picks A or B IN SECRET, then locks it in.",
          "2. Each of you then tries to GUESS the opponent's pick, and locks the guess in.",
          "3. Both picks and both guesses are revealed at the same time.",
        ] },
        { h: "Scoring", items: [
          "+1 point each if you both picked the SAME answer (compatibility).",
        ...
        { h: "End of game", items: [
          ...
          "The host sets the target score, the time per phase and the question types before starting.",
        ] },
      ],
    },
  },
    ...
    fr: {
      ...
      sections: [
        ...
        { h: "Deux dés", items: [
          ...
          "Un SEUL 6 dans le tirage offre une relance d'UN SEUL dé à la fin du tour ; DEUX 6 offrent une relance complète des deux dés — mais trois lancers avec un 6 d'affilée font perdre le tour.",
          "20 secondes pour jouer, dès le DÉBUT de votre tour (pas seulement après avoir lancé) ; le minuteur repart à zéro à chaque coup et à chaque nouvelle relance méritée.",
        ] },
        { h: "Cases sûres et cases « ? »", items: [
          "Les cases étoilées protègent vos pions : un adversaire ne peut pas vous y capturer.",
          "Atterrir pile sur une case « ? » ouvre une ROUE DE LA FORTUNE : cliquez dessus (ou appuyez sur Espace) pour la lancer — le résultat ne se révèle qu'à la fin de sa rotation, que tout le monde voit tourner.",
          "Bonus/malus classiques : +3 cases, recul de 4, un seul dé pour le joueur suivant, ou une relance offerte.",
          "Bonus/malus EXTRÊMES, bien plus rares : +8 cases d'un bond, un autre pion libéré directement de l'enclos, un pion renvoyé à l'enclos, ou un recul de 8 cases.",
        ] },
        { h: "Astuce", items: [
          "À votre tour, appuyez sur Espace pour lancer les dés — et aussi pour lancer la roue de la fortune quand une case « ? » l'exige.",
        ] },
      ],
    },
    en: {
      ...
      sections: [
        ...
        { h: "Two dice", items: [
          ...
          "A SINGLE 6 in the roll grants a re-roll of ONLY that die at the end of your turn; TWO 6s grant a full re-roll of both dice — but three rolls with a 6 in a row forfeit the turn.",
          "20 seconds to play, starting right at the BEGINNING of your turn (not only after rolling); the timer resets fully on every move and every earned re-roll.",
        ] },
        { h: "Safe spots and « ? » tiles", items: [
          "Starred spaces protect your pawns: opponents can't capture you there.",
          "Landing exactly on a « ? » tile opens a WHEEL OF FORTUNE: click it (or press Space) to spin — the result is only revealed once it stops spinning, and everyone watches it turn.",
          "Classic bonuses/penalties: +3 spaces, 4 spaces back, a single die for the next player, or a free re-roll.",
          "EXTREME bonuses/penalties, much rarer: an 8-space leap, another token freed straight from the yard, a token sent back to the yard, or an 8-space setback.",
        ] },
        { h: "Tip", items: [
          "On your turn, press Space to roll the dice — and also to spin the wheel of fortune whenever a « ? » tile calls for it.",
        ] },
      ],
    },
  },
