...
export const GAME_RULES = {
  ...
  ousthat: {
    fr: {
      title: "⌖ Où's that ? · règles",
      intro: "Street View en solo ou jusqu’à 8 joueurs : enchaînez les pays, jouez cinq manches de précision ou affrontez vos amis.",
      sections: [
        { h: "Modes solo", items: [
          "Country Streak : trouvez le pays au QCM de drapeaux ou avec la recherche complète. La série s’arrête à la première erreur.",
          "Pinpoint : placez un marqueur pendant cinq manches ; le résultat final est noté sur 25 000 points.",
        ] },
        { h: "Modes multijoueur", items: [
          "Pays : de 2 à 8 joueurs répondent au même panorama pendant cinq manches ; chaque bonne réponse vaut un point.",
          "Pinpoint : le meilleur score de la manche ne perd rien. Chaque autre joueur perd son écart avec ce meilleur score, multiplié par le multiplicateur de manche.",
          "Un joueur à 0 PV observe la suite. La dernière personne encore en jeu gagne.",
        ] },
        { h: "Réponse et score", items: [
          "Tous les joueurs reçoivent le même panorama Google Street View, avec la même orientation de départ.",
          "Une réponse confirmée est définitive. À l’expiration, le dernier choix non confirmé compte quand même.",
          "Une réponse à 25 m ou moins vaut 5 000 points. Au-delà, le score Arcardi décroît avec la distance, jusqu'à 0.",
        ] },
        { h: "Réglages et incidents", items: [
          "L'hôte choisit les PV initiaux, la durée des manches, le délai final et la progression des multiplicateurs.",
          "Si un panorama est indisponible, signalez-le : le lieu est annulé et remplacé sans avancer le numéro de manche.",
        ] },
      ],
    },
    en: {
      title: "⌖ Où's that ? · rules",
      intro: "Street View for one to eight players: build a country streak, play five pinpoint rounds, or face your friends.",
      sections: [
        { h: "Solo modes", items: [
          "Country Streak: identify the country with flag multiple choice or full search. The streak ends on the first mistake.",
          "Pinpoint: place a marker for five rounds; the final result is scored out of 25,000.",
        ] },
        { h: "Multiplayer modes", items: [
          "Country: two to eight players answer the same five panoramas; each correct answer earns one point.",
          "Pinpoint: the best round score takes no damage. Every other player loses their score gap from the leader, multiplied by the round multiplier.",
          "A player at 0 health watches the rest. The last remaining player wins.",
        ] },
        { h: "Answers and scoring", items: [
          "Everyone receives the same Google Street View panorama with the same starting orientation.",
          "A confirmed answer cannot be changed. At timeout, the last unconfirmed choice still counts.",
          "A guess within 25 m scores 5,000 points. Beyond that, the Arcardi score decreases with distance down to 0.",
        ] },
        { h: "Settings and issues", items: [
          "The host sets starting health, round length, final countdown, and multiplier progression.",
          "If a panorama is unavailable, report it: that location is voided and replaced without advancing the round number.",
        ] },
      ],
    },
  },
  ...
  echoes: {
    fr: {
      ...
      sections: [
        { h: "But", items: [
          "16 chapitres à résoudre en communiquant (voix ou chat) ce que chacun voit de son côté : aucun des deux n'a jamais toute l'information seul.",
          "Au programme : code des lanternes, rouages, soute à peser, tuyauterie à pivoter, mémoire, décor mouvant, fanal à décoder, vannes, cadran, miroirs et faisceau, lampisterie à bascule, chiffre du gardien, cale aveugle à guider, jarres à transvaser, carte des étoiles...",
          "Et pour finir : le Naufrage. Chacun dans sa cale qui tangue et prend l'eau, une lanterne à trouver dans le noir, la bonne clé (dictée par le binôme) qui coule, un cadenas, et deux leviers à tirer exactement en même temps.",
        ] },
        { h: "Chrono commun", items: [
          "22 minutes pour tout le monde. Une mauvaise tentative fait perdre du temps à l'équipe entière, et une mauvaise clé sur le cadenas du final coûte une minute entière.",
        ] },
      ],
    },
    en: {
      ...
      sections: [
        { h: "Goal", items: [
          "16 chapters to solve by describing to each other (voice or chat) what you each see on your side : neither of you ever has the full picture alone.",
          "On the menu: lantern code, gears, cargo hold weighing, pipework to rotate, memory, moving décor, signal light to decode, valves, dial, mirrors and beam, flip-the-lamps board, the keeper's cipher, a blind hold to guide, jars to pour, the star chart...",
          "And to finish: the Shipwreck. Each of you in a listing, flooding hold, a lantern to find in the dark, the right key (called out by your partner) sinking away, a padlock, and two levers to pull at exactly the same time.",
        ] },
        { h: "Shared timer", items: [
          "22 minutes for the whole team. A wrong attempt costs the whole team time, and a wrong key on the finale padlock costs a full minute.",
        ] },
      ],
    },
  },
  ...
  heist: {
    fr: {
      ...
      sections: [
        { h: "But", items: [
          "7 coups à réussir en communiquant (voix ou chat) ce que chacun voit. Aucun des deux n'a jamais toute l'information seul.",
          "Boîtier d'alarme, champ de lasers, coffre, pièce authentique, ronde du gardien, réserves obscures, puis la Joconde. Les réserves obscures : l'un traverse un labyrinthe noir à la lampe torche pendant que l'autre le guide au plan ; la torche tombe en panne à mi-chemin (3 erreurs et c'est fini), un gardien somnolent y patrouille (camouflage 20 s pour passer). La Joconde reste le coup final, le plus long : deux codes de 5 symboles à information croisée, puis un décrochage parfaitement synchronisé. Gardez du temps pour elle.",
        ] },
        { h: "Deux façons de tout perdre", items: [
          "La ronde du gardien dure 8 minutes. Si le temps s'écoule, vous êtes cueillis à l'intérieur.",
    ...
    en: {
      ...
      sections: [
        { h: "Goal", items: [
          "7 jobs to pull off by describing to each other (voice or chat) what you each see. Neither of you ever has the full picture alone.",
          "Alarm box, laser field, vault, genuine piece, guard's round, dark storerooms, then the Mona Lisa. The dark storerooms: one of you crosses a pitch-black maze by flashlight while the other guides from the map; the torch dies halfway (3 wrong turns and it's over), and a drowsy guard patrols (20s camouflage to slip past). The Mona Lisa is still the final and longest job: two 5-symbol codes with crossed clues, then a perfectly synchronized lift. Save time for her.",
        ] },
        { h: "Two ways to lose everything", items: [
          "The guard's round lasts 8 minutes. If time runs out, you're caught inside.",
    ...
    fr: {
      ...
      sections: [
        { h: "Déroulé", items: [
          ...
          "Cliquez une de vos pièces puis la case d'arrivée (les points), ou glissez-la directement.",
          "Pendant le tour adverse, vous pouvez préparer un pré-coup (en bleu) : il part dès que l'adversaire a joué, s'il est encore légal.",
          "Chaque joueur a une pendule, avec un incrément en 3+2 et 5+3 (secondes ajoutées à chaque coup). Temps à zéro : partie perdue, sauf si l'adversaire ne peut plus mater.",
          "Clic droit (ou glisser en clic droit) : cercles et flèches pour réfléchir, visibles de vous seul. ← → pour revoir les coups pendant la partie.",
        ] },
        { h: "Fin de partie", items: [
          ...
          "Nulle aussi par manque de matériel, répétition de position, règle des 50 coups, ou d'un commun accord (½ Proposer nulle).",
          "Avant que chacun ait joué son premier coup, la partie peut être annulée sans résultat.",
        ] },
        { h: "Coups spéciaux", items: [
          ...
          "Reprendre : demandez à annuler votre dernier coup, l'adversaire doit accepter (l'ordinateur accepte toujours).",
          "Pièces : Cburnett (Colin M.L. Burnett), licence BSD 3 clauses.",
        ] },
      ],
    },
    en: {
      ...
      sections: [
        { h: "How to play", items: [
          ...
          "Click one of your pieces then the destination square (the dots), or simply drag it there.",
          "During your opponent's turn you can set up a premove (in blue): it plays as soon as they move, if still legal.",
          "Each player has a clock, with an increment in 3+2 and 5+3 (seconds added after each move). Run out of time and you lose, unless your opponent can no longer mate.",
          "Right-click (or right-drag): circles and arrows to think with, seen only by you. ← → to replay the moves during the game.",
        ] },
        { h: "Ending the game", items: [
          ...
          "Also a draw by insufficient material, threefold repetition, the 50-move rule, or by agreement (½ Offer draw).",
          "Before both players have made their first move, the game can be aborted with no result.",
        ] },
        { h: "Special moves", items: [
          ...
          "Takeback: ask to undo your last move, your opponent has to accept (the computer always does).",
          "Pieces: Cburnett (Colin M.L. Burnett), BSD 3-clause license.",
        ] },
      ],
    },
  },
  naval: {
    fr: {
      title: "⚓ Bataille navale · règles",
      intro: "Place ta flotte en secret, puis coule celle de l'adversaire case par case. Deux joueurs, grille 10×10, vue 2D de dessus ou 3D isométrique au choix.",
      sections: [
        { h: "Ta flotte", items: [
          "Cinq navires : porte-avions (5×2), croiseur (4), contre-torpilleur (3), sous-marin (3), torpilleur (2).",
          "Glisse chaque navire depuis la zone de droite vers ta grille ; repositionne-le en le tirant, pivote-le avec le badge ⟳, ou utilise le placement automatique. Le porte-avions occupe un rectangle de 5 par 2 cases.",
          "Un chrono limite la phase de placement : à son terme, les navires manquants sont posés au hasard.",
        ] },
        { h: "Le combat", items: [
          "Chacun son tour, tire sur une case de la grille adverse.",
          "Touché : tu rejoues. Manqué : c'est au tour de l'adversaire. Un chrono limite chaque tir.",
          "Un navire dont toutes les cases sont touchées est coulé (l'épave apparaît).",
        ] },
        { h: "Bonus", items: [
          "Missile lourd (1×/partie) : frappe une zone de 3×3 cases d'un coup.",
          "Pluie de missiles (1×/partie) : révèle 5 cases non encore frappées au hasard.",
          "Toucher via un bonus laisse le tour au joueur, comme un tir normal.",
        ] },
        { h: "Vues", items: [
          "Bascule entre la vue 2D de dessus et la vue 3D isométrique à tout moment, sans interrompre la partie.",
        ] },
        { h: "Score", items: [
          "Le premier à couler toute la flotte adverse gagne la manche. Les victoires se cumulent d'une manche à l'autre.",
        ] },
      ],
    },
    en: {
      title: "⚓ Battleship · rules",
      intro: "Secretly place your fleet, then sink the opponent's one cell at a time. Two players, 10×10 grid, top-down 2D or isometric 3D view.",
      sections: [
        { h: "Your fleet", items: [
          "Five ships: carrier (5×2), cruiser (4), destroyer (3), submarine (3), torpedo boat (2).",
          "Drag each ship from the pickup zone onto your grid; reposition it by dragging, rotate it with the ⟳ badge, or use auto-placement. The carrier fills a 5 by 2 rectangle.",
          "A timer limits the placement phase: when it runs out, any missing ships are placed at random.",
        ] },
        { h: "Combat", items: [
          "Take turns firing at a cell on the enemy grid.",
          "Hit: you fire again. Miss: it's the opponent's turn. A timer limits each shot.",
          "A ship whose every cell has been hit is sunk (its wreck appears).",
        ] },
        { h: "Power-ups", items: [
          "Heavy missile (1×/game): strikes a 3×3 area in one blow.",
          "Missile rain (1×/game): reveals 5 random cells that haven't been fired at yet.",
          "Landing a hit with a power-up keeps your turn, like a normal shot.",
        ] },
        { h: "Views", items: [
          "Switch between top-down 2D and isometric 3D view at any time, without interrupting the game.",
        ] },
        { h: "Scoring", items: [
          "The first to sink the entire enemy fleet wins the round. Wins add up from round to round.",
        ] },
      ],
    },
  },
  calcrace: {
    fr: {
      title: "🏎️ Course de calcul mental · règles",
      intro: "Résous des opérations pour faire avancer ta voiture de F1 sur la piste. Seul contre la montre, ou jusqu'à 10 joueurs en même temps.",
      sections: [
        { h: "Le principe", items: [
          "Une opération s'affiche : additions, soustractions, multiplications, divisions, racines carrées, exposants, équations à une inconnue.",
          "Tape la réponse au clavier : dès qu'elle est correcte, la question suivante s'affiche automatiquement, pas besoin de valider.",
          "Une réponse fausse ne pénalise pas : rien ne se passe, il suffit de corriger.",
        ] },
        { h: "L'avancée", items: [
          "Plus la réponse juste arrive vite, plus la voiture avance loin.",
          "Une réponse juste fait toujours avancer un minimum, même si elle a mis du temps à venir.",
        ] },
        { h: "La course", items: [
          "En solo, c'est un contre-la-montre : essaie de finir le plus vite possible.",
          "À plusieurs (jusqu'à 10), tout le monde résout exactement les mêmes opérations, dans le même ordre : course équitable.",
          "La première voiture à franchir la ligne d'arrivée met fin à la manche.",
        ] },
      ],
    },
    en: {
      title: "🏎️ Mental math race · rules",
      intro: "Solve operations to move your F1 car along the track. Solo time trial, or up to 10 players at once.",
      sections: [
        { h: "The idea", items: [
          "An operation appears: addition, subtraction, multiplication, division, square roots, exponents, one-unknown equations.",
          "Type the answer: as soon as it's correct, the next question appears automatically, no need to submit.",
          "A wrong answer isn't penalized: nothing happens, just correct it.",
        ] },
        { h: "Moving forward", items: [
          "The faster a correct answer comes in, the further the car moves.",
          "A correct answer always moves the car forward at least a bit, even if it took a while.",
        ] },
        { h: "The race", items: [
          "Solo, it's a time trial: try to finish as fast as you can.",
          "With others (up to 10), everyone solves the exact same operations, in the same order: a fair race.",
          "The first car to cross the finish line ends the round.",
        ] },
      ],
    },
  },
  puzzle: {
    fr: {
      title: "🧩 Puzzle Race · règles",
      intro: "Reconstitue une image découpée en pièces à pattes. Chacun a sa propre copie, dans son coin : le premier qui termine gagne. Le mode collaboratif (un plateau partagé) arrivera dans une prochaine mise à jour.",
      sections: [
        { h: "Avant de commencer", items: [
          "L'hôte choisit l'illustration et le nombre de pièces (12, 24 ou 54).",
          "Chaque joueur reçoit sa propre copie du puzzle, mélangée indépendamment : tout le monde a la même image et le même nombre de pièces.",
        ] },
        { h: "Assembler", items: [
          "Glisse une pièce vers son emplacement : elle se verrouille automatiquement quand elle est assez proche de la bonne position, avec une petite surbrillance aux joints.",
          "Une image de référence, discrète, reste visible sous les pièces pour se repérer.",
        ] },
        { h: "La partie", items: [
          "Seul, c'est un contre-la-montre : essaie de finir le plus vite possible.",
          "À plusieurs, la progression et le temps de chacun sont visibles en direct ; le premier puzzle terminé met fin à la manche et le classement se fait au temps.",
        ] },
      ],
    },
    en: {
      title: "🧩 Puzzle Race · rules",
      intro: "Rebuild a picture cut into interlocking pieces. Everyone has their own copy, in their own corner: first to finish wins. Collaborative mode (one shared board) is coming in a future update.",
      sections: [
        { h: "Before you start", items: [
          "The host picks the illustration and the piece count (12, 24, or 54).",
          "Each player gets their own copy of the puzzle, shuffled independently: everyone has the same image and the same piece count.",
        ] },
        { h: "Assembling", items: [
          "Drag a piece toward its spot: it locks in automatically once it's close enough to the right position, with a small highlight at the joints.",
          "A faint reference image stays visible under the pieces to help you get your bearings.",
        ] },
        { h: "The match", items: [
          "Solo, it's a time trial: try to finish as fast as you can.",
          "With others, everyone's progress and time are visible live; the first finished puzzle ends the round and the ranking is by time.",
        ] },
      ],
    },
  },
  ferme: {
    fr: {
      title: "🌾 Ferme Vallée · règles",
      intro: "Une ferme coopérative en temps réel. Tout le monde partage le même monde et la même caisse commune : cultivez, récoltez, coupez du bois, cassez des rochers et vendez pour enrichir l'équipe. Jouable seul ou jusqu'à 8.",
      sections: [
        { h: "Se déplacer et agir", items: [
          "ZQSD, WASD ou les flèches pour bouger dans 8 directions.",
          "Espace ou clic gauche pour utiliser l'outil sélectionné sur la tuile ciblée (souris ou case devant vous).",
          "Touches 1 à 6 ou molette pour changer d'outil : houe, arrosoir, hache, pioche, graines, casse-croûte.",
          "Bouton 🏠 pour vous téléporter devant la maison, et 🗺️ pour ouvrir la carte de la vallée avec la position de chacun.",
        ] },
        { h: "Cultiver", items: [
          "Labourez l'herbe (houe), plantez une graine, puis arrosez chaque jour (arrosoir).",
          "Au changement de jour, les cultures arrosées poussent d'un cran ; récoltez au stade final.",
          "Un jour dure 8 minutes réelles, avec un cycle jour/nuit. L'énergie se régénère chaque matin.",
        ] },
        { h: "Récolter la nature", items: [
          "Coupez les arbres (hache) pour du bois et cassez les rochers (pioche) pour de la pierre.",
          "En cassant les rochers, vous trouvez parfois une gemme rare (améthyste, émeraude, diamant) qui se vend très cher.",
          "Pêchez à la rivière (canne, touche 7) : les poissons se mangent pour regagner de l'énergie ou se revendent au bac.",
          "La nature repousse lentement, loin de la ferme, à chaque nouveau jour.",
        ] },
        { h: "Découverte guidée", items: [
          "Un panneau 'À faire' liste des petites quêtes de départ (labourer, planter, pêcher, vendre...).",
          "Chaque quête accomplie rapporte de l'or à la caisse commune. Le panneau se referme et se rouvre avec le bouton dédié.",
        ] },
        { h: "S'équiper et élever", items: [
          "Cheval : achète-le à la boutique, approche-toi et appuie sur F pour l'enfourcher et te déplacer bien plus vite.",
          "Puits : une fois construit, un bouton 🪣 te téléporte dans les champs, en plus du bouton 🏠 Maison.",
          "Animaux d'élevage (poule, chèvre, brebis, cochon, vache) : achète-les au marché ; chaque matin ils produisent (oeuf, lait, laine, truffe) à ramasser près d'eux, puis à vendre au bac.",
          "La pêche est un petit défi d'adresse : plus le poisson est rare, plus le minijeu est exigeant.",
        ] },
        { h: "L'économie commune", items: [
          "Vendez cultures, bois et pierre au bac 💰 : l'or va dans la caisse commune de l'équipe.",
          "Achetez à la boutique 🛒 : graines, casse-croûtes et améliorations d'outils (3 niveaux, plus efficaces et moins fatigants).",
          "Tout le monde puise dans la même caisse : jouez la coopération.",
        ] },
      ],
    },
    en: {
      title: "🌾 Valley Farm · rules",
      intro: "A real-time co-op farm. Everyone shares the same world and the same pot of gold: grow crops, harvest, chop wood, break rocks and sell to make the team richer. Play solo or up to 8.",
      sections: [
        { h: "Move and act", items: [
          "WASD or arrow keys to move in 8 directions.",
          "Space or left click to use the selected tool on the targeted tile (mouse or the tile in front of you).",
          "Keys 1 to 6 or the wheel to switch tools: hoe, watering can, axe, pickaxe, seeds, snack.",
          "The 🏠 button teleports you in front of the house, and 🗺️ opens the valley map with everyone's live position.",
        ] },
        { h: "Farming", items: [
          "Till the grass (hoe), plant a seed, then water it every day (watering can).",
          "At the day change, watered crops grow one stage; harvest at the final stage.",
          "A day lasts 8 real minutes, with a day/night cycle. Energy refills every morning.",
        ] },
        { h: "Gathering", items: [
          "Chop trees (axe) for wood and break rocks (pickaxe) for stone.",
          "Breaking rocks sometimes yields a rare gem (amethyst, emerald, diamond) that sells for a lot.",
          "Fish in the river (rod, key 7): fish can be eaten to restore energy or sold at the bin.",
          "Nature slowly regrows, away from the farm, each new day.",
        ] },
        { h: "Guided discovery", items: [
          "A 'To do' panel lists starter quests (till, plant, fish, sell...).",
          "Each completed quest adds gold to the shared pot. The panel closes and reopens with its button.",
        ] },
        { h: "Gear up and raise animals", items: [
          "Horse: buy it at the shop, walk up to it and press F to mount and move much faster.",
          "Well: once built, a 🪣 button teleports you into the fields, on top of the 🏠 House button.",
          "Livestock (hen, goat, sheep, pig, cow): buy them at the market; each morning they produce (egg, milk, wool, truffle) to collect next to them, then sell at the bin.",
          "Fishing is a small skill challenge: the rarer the fish, the harder the minigame.",
        ] },
        { h: "The shared economy", items: [
          "Sell crops, wood and stone at the bin 💰: gold goes into the team's shared pot.",
          "Buy at the shop 🛒: seeds, snacks and tool upgrades (3 levels, more efficient and less tiring).",
          "Everyone draws from the same pot: play as a team.",
        ] },
      ],
    },
  },
