...
export const GAME_RULES = {
  ...
  ludo: {
    fr: {
      ...
      sections: [
        ...
        { h: "Astuce", items: [
          "À votre tour, appuyez sur Espace pour lancer le dé, en plus du bouton.",
        ] },
      ],
    },
    en: {
  ...
  heist: {
    fr: {
      title: "💎 Le Casse · règles",
      intro: "Escape room coopératif ASYMÉTRIQUE et NERVEUX à 2 joueurs : deux cambrioleurs infiltrés chacun dans une aile du musée, sans rien voir de l'autre.",
      sections: [
        { h: "But", items: [
          "6 coups à réussir en communiquant (voix ou chat) ce que chacun voit : aucun des deux n'a jamais toute l'information seul.",
          "Boîtier d'alarme, champ de lasers, coffre, pièce authentique, ronde du gardien, puis sortie synchronisée.",
        ] },
    ...
    en: {
      title: "💎 The Heist · rules",
      intro: "A tense ASYMMETRIC cooperative escape room for 2 players: two burglars each infiltrated in a museum wing, blind to the other's side.",
      sections: [
        { h: "Goal", items: [
          "6 jobs to pull off by describing to each other (voice or chat) what you each see: neither ever has the full picture alone.",
          "Alarm box, laser field, vault, genuine piece, guard's round, then a synchronized getaway.",
        ] },
  ...
  petitbac: {
    fr: {
      ...
      sections: [
        ...
        { h: "Points", items: [
          "Réponse valable et unique : 4 points.",
