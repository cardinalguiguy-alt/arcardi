...
export const GAME_RULES = {
  ...
  ousthat: {
    fr: {
      ...
      intro: "Un duel de géolocalisation à deux. Explorez le même panorama, placez votre réponse sur la carte et faites tomber les PV adverses.",
      sections: [
        { h: "Une manche", items: [
          "Les deux joueurs reçoivent le même panorama Google Street View, avec la même orientation de départ.",
          "Cliquez sur la carte, affinez votre marqueur puis confirmez. Une réponse confirmée est définitive.",
          "Quand le premier joueur confirme, le délai final réglé par l'hôte commence. À l'expiration, le dernier marqueur non confirmé compte quand même ; sans marqueur, le score vaut 0.",
        ] },
        { h: "Score et dégâts", items: [
          "Une réponse à 25 m ou moins vaut 5 000 points. Au-delà, le score Arcardi décroît avec la distance, jusqu'à 0.",
          "Seul le camp au score le plus faible perd des PV : dégâts = écart de score × multiplicateur, arrondi à l'entier le plus proche.",
          "Les égalités n'infligent aucun dégât. Le duel s'achève dès qu'un camp tombe à 0 PV.",
        ] },
    ...
    en: {
      ...
      intro: "A two-player geolocation duel. Explore the same panorama, place your answer on the map, and drain your opponent's health.",
      sections: [
        { h: "A round", items: [
          "Both players receive the same Google Street View panorama with the same starting orientation.",
          "Click the map, refine your marker, then confirm. A confirmed answer cannot be changed.",
          "When the first player confirms, the host's final countdown begins. At timeout, the last unconfirmed marker still counts; no marker scores 0.",
        ] },
        { h: "Score and damage", items: [
          "A guess within 25 m scores 5,000 points. Beyond that, the Arcardi score decreases with distance down to 0.",
          "Only the lower-scoring side loses health: damage = score gap × multiplier, rounded to the nearest integer.",
          "Ties deal no damage. The duel ends as soon as one side reaches 0 health.",
        ] },
