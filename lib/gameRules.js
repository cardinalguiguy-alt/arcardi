    ...
    fr: {
      ...
      sections: [
        { h: "Ta flotte", items: [
          ...
          "Place chaque navire sur ta grille (sélection, pivot, clic), ou utilise le placement automatique. Le porte-avions occupe un rectangle de 5 par 2 cases.",
        ...
        { h: "Le combat", items: [
          ...
          "Un navire dont toutes les cases sont touchées est coulé.",
        ] },
        { h: "Vues", items: [
    ...
    en: {
      ...
      sections: [
        { h: "Your fleet", items: [
          ...
          "Place each ship on your grid (select, rotate, click), or use auto-placement. The carrier fills a 5 by 2 rectangle.",
        ...
        { h: "Combat", items: [
          ...
          "A ship whose every cell has been hit is sunk.",
        ] },
        { h: "Views", items: [
