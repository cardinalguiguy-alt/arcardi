...
export const GAME_RULES = {
  ...
  goldmines: {
    fr: {
      ...
      intro: "Démineur inversé en 2 contre 2 (les sièges vides sont comblés par des bots). La mine cache 31 pépites d'or dans une grille de 12×12 : à vous de les extraire.",
      sections: [
        { h: "But", items: [
          "Chaque coup de pioche révèle une case : soit un CHIFFRE (le nombre de pépites dans les 8 cases voisines, les indices du démineur classique), soit une PÉPITE d'or.",
          "Une pépite trouvée rapporte 1 or à son mineur… et il REJOUE immédiatement.",
          "Une case vide (zéro pépite autour) dégage d'un coup toute la zone vide voisine, les pépites, elles, ne se révèlent jamais autrement qu'à la pioche directe.",
        ] },
        { h: "Équipes et tours", items: [
          "2 contre 2 : Équipe Or et Équipe Bleue, un coup de pioche chacun, en alternant les équipes à chaque tour.",
          "Trop lent ? Au bout de 30 secondes, la pioche part toute seule au hasard (5 s en cas de récidive).",
        ] },
        { h: "Fin de partie", items: [
          "Quand la dernière pépite est extraite, on compte l'or de chaque équipe : 31 pépites, donc jamais d'égalité, une équipe gagne, l'autre perd.",
          "Le classement individuel à l'or récolté attribue les points ARCARDI (l'équipe gagnante départage les ex æquo).",
        ] },
      ],
    },
    en: {
      title: "⛏️ Gold Mines · rules",
      intro: "Reverse minesweeper, 2 vs 2 (empty seats are filled by bots). The mine hides 31 gold nuggets in a 12×12 grid: dig them out.",
      sections: [
        { h: "Goal", items: [
          "Every dig reveals a tile: either a NUMBER (how many nuggets sit in the 8 neighbouring tiles, classic minesweeper hints), or a gold NUGGET.",
          "A nugget earns its miner 1 gold… and they immediately dig AGAIN.",
          "An empty tile (zero nuggets around) clears the whole neighbouring empty area at once, nuggets themselves are only ever revealed by a direct dig.",
        ] },
        { h: "Teams and turns", items: [
          "2 vs 2: Team Gold and Team Blue, one dig each, teams alternating every turn.",
          "Too slow? After 30 seconds the dig happens randomly on its own (5s for repeat offenders).",
        ] },
        { h: "Game end", items: [
          "When the last nugget is dug out, each team's gold is tallied: 31 nuggets means no ties, one team wins, the other loses.",
          "The individual gold ranking awards ARCARDI points (winning team breaks ties).",
        ] },
      ],
    },
  },
  ...
  petitbac: {
    fr: {
      ...
      intro: "Trouvez un mot par catégorie commençant par la lettre tirée, plus vite que les autres. Le Petit Bac (Scattergories) classique, 2 joueurs et plus, en français ou en anglais.",
      sections: [
        { h: "Une manche", items: [
    ...
    en: {
      ...
      intro: "Find one word per category starting with the drawn letter, faster than everyone else. The classic Scattergories game, 2+ players, in French or English.",
      sections: [
        { h: "A round", items: [
