...
export const GAME_RULES = {
  ...
  tenk: {
    fr: {
      title: "🎰 10 000 — règles",
      intro: "Jeu de dés au tour par tour, 6 dés, 2 à 4 joueurs (bots pour compléter la table). Objectif : le premier à atteindre la cible fixée par l'hôte (5000 ou 10000 pts) déclenche un dernier tour pour tout le monde — le meilleur score total gagne.",
      sections: [
        { h: "Un tour", items: [
          "Lancez les dés actifs (6 au départ). Choisissez vous-même quels dés garder parmi les combinaisons valables — le score correspondant s'affiche en direct.",
          ...
          "Après une sélection valable, relancez les dés restants ou banquez le score du tour (il est alors ajouté à votre total et le tour passe).",
          "Hot dice : si les 6 dés ont été mis de côté (en un ou plusieurs lancers), ils repartent tous ensemble, le score du tour continue de grimper.",
          "Farkle : si un lancer ne contient aucune combinaison valable, le tour s'arrête aussitôt et tout le score du tour (non banqué) est perdu.",
        ] },
      ],
      table: {
        headers: ["Combinaison", "Points"],
        rows: [
          ...
          ["🎲 Suite complète 1-2-3-4-5-6", "1500 pts"],
    ...
    en: {
      title: "🎰 10,000 — rules",
      intro: "A turn-based dice game, 6 dice, 2 to 4 players (bots fill empty seats). Goal: the first to reach the host's target (5000 or 10000 pts) triggers one final round for everyone — the best total score wins.",
      sections: [
        { h: "A turn", items: [
          "Roll the active dice (6 at the start). You choose which dice to keep among the valid combinations — the score updates live.",
          ...
          "After a valid selection, either re-roll the remaining dice or bank the turn score (added to your total, then the turn passes).",
          ...
          "Farkle: if a roll contains no valid combination at all, the turn ends immediately and the whole (unbanked) turn score is lost.",
        ] },
      ],
      table: {
        headers: ["Combination", "Points"],
        rows: [
          ...
          ["🎲 Full straight 1-2-3-4-5-6", "1500 pts"],
