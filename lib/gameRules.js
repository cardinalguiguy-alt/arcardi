...
export const GAME_RULES = {
  ...
  chromatik: {
    fr: {
      ...
      intro: "Jeu de cartes à défausse colorée, 2 à 4 joueurs (les sièges vides sont comblés par des bots). L'hôte choisit le nombre de manches (5, 7 ou 10) au lancement.",
      sections: [
        { h: "But", items: [
          "Sur chaque manche : soyez le premier à vider votre main.",
        ...
        { h: "Surenchère +2 / +4", items: [
          "Un +2 reçu peut être contré par un autre +2 (le total à piocher s'additionne et passe au joueur suivant).",
          "Un +4 reçu peut être contré par un +2 OU un +4.",
    ...
    en: {
      ...
      intro: "A colour-matching card game, 2 to 4 players (empty seats are filled by bots). The host picks the number of rounds (5, 7 or 10) at the start.",
      sections: [
        { h: "Goal", items: [
          "Each round: be the first to empty your hand.",
        ...
        { h: "+2 / +4 stacking", items: [
          "A +2 you receive can be countered with another +2 (the draw total adds up and passes to the next player).",
          "A +4 you receive can be countered with a +2 OR a +4.",
